...
public final class TraditionalSimplifiedWebServiceHttpGet_TraditionalSimplifiedWebServiceHttpGet_Client {

    private static final QName SERVICE_NAME = new QName("http://webxml.com.cn/", "TraditionalSimplifiedWebService");

    private TraditionalSimplifiedWebServiceHttpGet_TraditionalSimplifiedWebServiceHttpGet_Client() {
    }
    ...
    public static void main(String args[]) throws Exception {
        ...
        TraditionalSimplifiedWebServiceHttpGet port = ss.getTraditionalSimplifiedWebServiceHttpGet();  
